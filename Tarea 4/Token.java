...
class Token{
    ...
    static DataInputStream entrada; // Inicia en el nodo 0
    static DataOutputStream salida; //0 al 1
    static long token; //Token para incrementar
    ...
    static class Worker extends Thread{
        public void run(){
            try {
                ...
                System.err.println("Error de prueba: " + e);
            }
        }
    }
    ...
    public static void main(String[] args) throws Exception{
        ...
        //Y por ende se obtiene el stream y espera a que el hilo local se termine y ya esta conectado.
        //Ya se tiene el Stream de salida pero no se sabe si el thread se haya terminado.
